// src/screens/services/CropHealthScreen.tsx
...
const CropHealthScreen: React.FC = () => {
  ...
  const handleSubmit = () => {
    if (!formData.farmLocation || !formData.cropType) {
    ...
    Alert.alert(
      'Success',
      'Your crop health monitoring request has been submitted!',
      [
        {
          text: 'OK',
  ...
  return (
    <View style={styles.container}>
      <LinearGradient
        colors={[colors.cropGreen, colors.secondary]}
        style={styles.header}
      >
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            <Text style={styles.label}>Health Concerns & Requirements</Text>
            <TextInput
              style={[styles.input, styles.textArea]}
              placeholder="Describe any crop health issues, symptoms, or monitoring requirements..."
              placeholderTextColor={colors.textSecondary}
