// src/screens/services/SoilHealthMapScreen.tsx
...
const SoilHealthMapScreen: React.FC = () => {
  ...
  const handleSubmit = () => {
    if (!formData.farmLocation || !formData.soilType || !formData.cropType) {
    ...
    Alert.alert(
      'Success',
      'Your soil health mapping request has been submitted!',
      [
        {
          text: 'OK',
  ...
  return (
    <View style={styles.container}>
      <LinearGradient
        colors={[colors.soilBrown, '#8B4513']}
        style={styles.header}
      >
        <SafeAreaView edges={['top']}>
          <View style={styles.headerContent}>
            ...
            <Text style={styles.headerTitle}>Soil Health Mapping</Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            <Text style={styles.label}>Current Soil Type</Text>
            <TextInput
              style={styles.input}
              placeholder="Enter known soil type (if any)"
              placeholderTextColor={colors.textSecondary}
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder="Describe any specific soil analysis requirements or concerns..."
              placeholderTextColor={colors.textSecondary}
...
export default SoilHealthMapScreen;